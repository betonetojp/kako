...
namespace kako
{
    public static class NostrAccess
    {
        ...
        #region タイムライン購読処理
        /// <summary>
        /// タイムライン購読処理（チャンネルメッセージ）
        /// </summary>
        /// <param name="channelId">対象チャンネルID(hex)</param>
        public static async Task SubscribeAsync(string? channelId = null)
        {
            if (_clients == null)
            {
                return;
            ...
            {
                filter.ReferencedEventIds = [channelId];
            }
